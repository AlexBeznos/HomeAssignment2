...
8. Quality criterion of robots by different index should be determined as attitude of absolute value of difference of robot's parametr ffrom the best to this the best value.
